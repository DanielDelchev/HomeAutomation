...
<html>
    <head>
        ...
        <title>Relay1_appointments</title>
        <script type="text/javascript" src="/static/jquery.js"></script>
        <link rel="stylesheet" href="/static/bootstrap.min.css">
        <script src="/static/bootstrap.min.js"></script>
        
        <br>
        <h1>Relay1 Appointments (in server time!):</h1>
        </br>
    ...
    <body>
        ...
        <form>
            ...
            <input id="submitID" type="submit" onclick="remove_singleR1()">
            </fieldset>
        </form>    
        ...
        <br>
        <h3 id="eraser">Erase ALL appointments for Relay1:</h3>
		<button type="erase" id="erase" onclick="erase_all_R1()" class="btn btn-danger">erase</button>
        <br>
